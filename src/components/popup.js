...
const Popup = ({ isOpen, closePopup }) => {
  ...
  const addresses = {
    ...
    POLYGON: '0x6d59fD29c048e22022bbAB5df74b655bb7e69dD5' // Polygon Address (example)
  };
  ...
  const cryptoLogos = [
    ...
    { logo: 'https://cryptologos.cc/logos/polygon-matic-logo.png', name: 'POLYGON' } // Polygon logo
  ];
